...
public class InterFaceController {
    ...
    public ResponseResult findByName(String interfaceName,String jsessionid){
        return new ResponseResult().success(ResultCode.SUCCESS.getCode(),true,"查询接口详情成功",interFaceService.queryByName(interfaceName,jsessionid));
    }
}
